...
export const POLICY_TOPIC_ICONS = {
  ...
  5: p => <PolicyTopic5 color={p.color || 'black'} {...p} />,
  10: p => <PolicyTopic10 color={p.color || 'black'} {...p} />,
};
...
export const RESOURCES = {
  ...
  DATA: IS_TEST
    ? 'https://wwf-deutschland.github.io/plastic-navigator-test/data'
    : 'https://plasticnavigator.wwf.de/data',
  DATA_API: IS_TEST
    ? 'https://advocacy-tracker-dev.herokuapp.com/api/v1/public/'
    : 'https://advocacy-tracker-api.herokuapp.com/api/v1/public/',
  // resources are generated by jekyll as a static site, path is determined by resource permalink
  CONTENT: IS_TEST
    ? 'https://wwf-deutschland.github.io/plastic-navigator-test/content'
    : 'https://plasticnavigator.wwf.de/content',
  IMAGES: IS_TEST
    ? 'https://wwf-deutschland.github.io/plastic-navigator-test/assets/uploads'
