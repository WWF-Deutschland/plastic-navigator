...
// export const getCurrentPosition = (positions, config) => {
...
//       console.log('country positions', f.properties.code, positions)
//       const position = getCurrentPosition(positions, config);
//       return {
...
//   excludeStatic,
// ) => {
//   console.log('getCountryPositionsOverTimeFromCountryFeatures')
//   const sources = features
...
//   });
//   console.log('sourcesSorted', sourcesSorted)
